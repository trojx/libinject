...
static int _wrap_version(lua_State* L) {
  ...
  SWIG_check_num_args("libinjection_version",0,0)
...
static int _wrap_sqli(lua_State* L) {
  int SWIG_arg = 0;
  char *arg1 = (char *) 0 ;
  size_t arg2 ;
  char *arg3 ;
  ...
  SWIG_check_num_args("libinjection_sqli",3,3)
  if(!SWIG_lua_isnilstring(L,1)) SWIG_fail_arg("libinjection_sqli",1,"char const *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("libinjection_sqli",2,"size_t");
  if(!SWIG_lua_isnilstring(L,3)) SWIG_fail_arg("libinjection_sqli",3,"char []");
...
static int _wrap_xss(lua_State* L) {
  int SWIG_arg = 0;
  char *arg1 = (char *) 0 ;
  size_t arg2 ;
  int result;
  
  SWIG_check_num_args("libinjection_xss",2,2)
  if(!SWIG_lua_isnilstring(L,1)) SWIG_fail_arg("libinjection_xss",1,"char const *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("libinjection_xss",2,"size_t");
  arg1 = (char *)lua_tostring(L, 1);
  SWIG_contract_assert((lua_tonumber(L,2)>=0),"number must not be negative")
  arg2 = (size_t)lua_tonumber(L, 2);
...
static swig_lua_const_info swig_constants[] = {
    {SWIG_LUA_CONSTTAB_INT("g_whitelist_length", 800)},
